...
const mainlandingLightBox = document.querySelector(
  ".lightbox-container .main-landing"
);
...
const cart = document.querySelector(".card-wrp");
const closeLightboxBtn = document.querySelector(".close-lightbox");
const lightbox = document.querySelector(".lightbox");
const addBtn = document.querySelector(".add_btn");
const indicator = document.querySelector(".indicator");
const wrp = document.querySelector(".card-content");
let amountValue = 0;
let currentImg = 1;
...
function addItem() {
  ...
  if(amountValue==""){
    addempty.textContent = `product can't be empty`;
  }
    if (amountValue > 0) {
    ...
    wrp.innerHTML = `<div class="product">
                    <div>
                      ...
                      <button class="delete-btn" onclick="deleteItem()"><img src="./images/icon-delete.svg" alt="delete">delete</button>
                    </div>
  ...
  image.addEventListener("click", () => {
    ...
    switch (selectedImg.getAttribute("src")) {
      case "./images/image-product-1-thumbnail.jpg":
        mainlanding.src = "./images/image-product-1.jpg";
        mainlandingLightBox.src = "./images/image-product-1.jpg";
        break;
      case "./images/image-product-2-thumbnail.jpg":
        mainlanding.src = "./images/image-product-2.jpg";
        mainlandingLightBox.src = "./images/image-product-2.jpg";
        break;
      case "./images/image-product-3-thumbnail.jpg":
        mainlanding.src = "./images/image-product-3.jpg";
        mainlandingLightBox.src = "./images/image-product-3.jpg";
        break;
      case "./images/image-product-4-thumbnail.jpg":
        mainlanding.src = "./images/image-product-4.jpg";
        mainlandingLightBox.src = "./images/image-product-4.jpg";
        break;
    }
  });
});
...
mainlanding.addEventListener("click", openLightBox);
